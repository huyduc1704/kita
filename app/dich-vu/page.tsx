...
export default function ServicesPage() {
  const title = 'DỊCH VỤ CỦA GAMMA HOME';
  const description = 'GAMMA HOME cung cấp các giải pháp toàn diện về tư vấn thiết kế kiến trúc, thiết kế nội thất, thi công phần thô và xây nhà trọn gói chìa khóa trao tay. Với triết lý "Tận tâm trong từng viên gạch", chúng tôi cam kết mang lại sản phẩm đạt chất lượng cao, thẩm mỹ vượt trội, giá thành hợp lý và chính sách bảo hành bảo trì hoàn hảo.';
