  ...
  return (
    <>
      ...
      <div className="fixed bottom-6 left-6 z-40 flex flex-col gap-3 items-start select-none">
        ...
        <a
          href="tel:0827972555"
          className="group relative flex items-center justify-center w-12 h-12 rounded-full bg-[#f48c06] border-2 border-white text-white shadow-lg transition-all duration-300 active:scale-95 hover:scale-105 z-10 animate-float-shake"
        ...
        >
          ...
          {/* Pulsing rings */}
          <span className="absolute inset-0 rounded-full bg-[#f48c06] animate-float-pulse-1 pointer-events-none -z-10"></span>
          <span className="absolute inset-0 rounded-full bg-[#f48c06] animate-float-pulse-2 pointer-events-none -z-10"></span>
        ...
        <a
          ...
          className="group relative flex items-center justify-center w-12 h-12 rounded-full overflow-hidden transition-all duration-300 active:scale-95 shadow-[0_0_15px_rgba(0,104,255,0.25)] hover:scale-105 z-10 bg-white border-2 border-[#0068ff] animate-float-shake"
          aria-label="Zalo Chat"
        >
          <span className="absolute left-14 bg-zinc-900/90 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300 whitespace-nowrap shadow-md z-30">
            Zalo Chat
          </span>
          <span className="absolute inset-0 rounded-full bg-[#0068ff]/15 animate-float-pulse-1 pointer-events-none -z-10"></span>
          <span className="absolute inset-0 rounded-full bg-[#0068ff]/10 animate-float-pulse-2 pointer-events-none -z-10"></span>
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group relative flex items-center justify-center w-12 h-12 rounded-full overflow-hidden transition-all duration-300 active:scale-95 shadow-[0_0_15px_rgba(0,132,255,0.25)] hover:scale-105 z-10 bg-[#0084ff] border-2 border-white animate-float-shake"
          aria-label="Facebook Messenger"
        >
          <span className="absolute left-14 bg-zinc-900/90 text-white text-xs font-semibold px-3 py-1.5 rounded-lg opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-all duration-300 whitespace-nowrap shadow-md z-30">
            Facebook Messenger
          </span>
          <span className="absolute inset-0 rounded-full bg-[#0084ff]/30 animate-float-pulse-1 pointer-events-none -z-10"></span>
          <span className="absolute inset-0 rounded-full bg-[#0084ff]/20 animate-float-pulse-2 pointer-events-none -z-10"></span>
        ...
        <button
          ...
          className="bg-[#f48c06] hover:bg-amber-600 text-white font-bold text-[11px] md:text-xs uppercase tracking-wider pl-3 pr-5 py-2.5 rounded-r-full rounded-l-md border-2 border-white shadow-lg flex items-center gap-2.5 transition-all duration-300 active:scale-95 group cursor-pointer animate-float-shake"
        >
        ...
        >
          ...
          <svg className="absolute inset-0 w-full h-full -rotate-90" viewBox="0 0 48 48">
            ...
            <circle
              ...
              cy="24"
              r="22"
              className="fill-none stroke-[#f48c06] transition-all duration-100"
              strokeWidth="2.5"
              strokeDasharray="138"
          ...
          <ArrowUp size={18} className="relative z-10 text-[#f48c06] group-hover:-translate-y-1 transition-transform duration-300 stroke-[2.5]" />
        </button>
      )}
